...
import com.lifeix.androidbasecore.download.http.AsyncHttpClient;
import com.lifeix.androidbasecore.download.http.AsyncHttpResponseHandler;
import com.lifeix.androidbasecore.download.http.FileHttpResponseHandler;
import com.lifeix.androidbasecore.download.http.TAStringUtils;
...
public class DownloadManager extends Thread {
	...
	private static int MAX_DOWNLOAD_THREAD_COUNT = 3;
	...
	public static final String FILE_ROOT = SDCARD_ROOT + "lifeix/";
	...
	/**
	 * 设置下载线程数量，可用范围[3,8]，默认下载线程数量为3
	 * 
	 * @param downloadSize
	 */
	public void setDownloadThreadSize(int downloadSize) {
		if (downloadSize < 3 || downloadSize > 8) {
			throw new RuntimeException(
					"download size must more than 3 and less than 8");
		}
		MAX_DOWNLOAD_THREAD_COUNT = downloadSize;
		DownLoadConfigUtil.setURL_COUNT(downloadSize);
	}
