 ...
 * Original file: D:\\Github\\AndroidFrame\\AndroidBaseCore\\src\\com\\lifeix\\androidbasecore\\download\\IDownloadService.aidl
 */
package com.lifeix.androidbasecore.download;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.lifeix.androidbasecore.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.lifeix.androidbasecore.download.IDownloadService";
...
/**
 * Cast an IBinder object into an com.lifeix.androidbasecore.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.lifeix.androidbasecore.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.lifeix.androidbasecore.download.IDownloadService))) {
return ((com.lifeix.androidbasecore.download.IDownloadService)iin);
}
return new com.lifeix.androidbasecore.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.lifeix.androidbasecore.download.IDownloadService
{
